...
const Hero = () => {
 ...
 <div className='bg-blue-800 w-[100%] h-[40rem] pt-6 md:pt-[12vh] md:h-[100vh] '>
    ...
    <div className='flex flex-col gap-3 text-white'>
       <div className='flex   '>
       <p className='pr-2  mb-[1.3rem]'>WELCOME TO LOANTEAM</p>
       <div className='bg-yellow-200 rounded-full w-5 h-5'></div>
        <div className='bg-indigo-300 rounded-full w-5 h-5 '></div>
       </div>
       <div >
        <h1 className='text-6xl font-semibold  text-white xl:text-[60px] md:text-[35px] sm:text-[25px] '>Seamless Loans, Brighter Futures</h1>
       </div>
    <div className='flex '>
    ...
    <div className='hidden md:block'>
        <Image src='/images/card1.png' width={400} height={400} alt='card1'
        className=''
        />
        <Image src='/images/card2.png' width={400} height={400} alt='card1'
