...
const Blog = () => {
  return (
    <div className='bg-white w-auto h-full text-white'>
      ...
      <main>
      <div className='grid grid-cols-1 lg:grid-cols-2  items-center justify-center gap-7 w-[80%] lg:ml-[7rem] md:mx-auto'>
          <div>
         ...
         and what you need we will provide for you as soon as possible.
          ...
          <div className='bg-blue-500 w-[15rem] h-[20rem] rounded-xl -mt-[10rem]'>
              <div className='flex flex-row justify-around mt-3'>
              <span>4.5</span>
              <StarIcon width={20}/>
              </div>
